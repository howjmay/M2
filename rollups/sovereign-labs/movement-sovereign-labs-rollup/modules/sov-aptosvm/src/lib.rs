...
mod aptos {
    ...
    pub struct AptosVm<C: sov_modules_api::Context> {
        ...
        // #[cfg(feature = "aptos-consensus")]
        #[state]
        pub(crate) validator_signer: sov_state::StateValue<Vec<u8>>, // TODO: fix validator signer incompatibility
        ...
        // #[cfg(feature = "aptos-consensus")]
        #[state]
        pub(crate) transactions: sov_state::StateMap<String, Vec<u8>>, // TODO: fix Transaction serialiation incompatibility

        // #[cfg(feature = "aptos-consensus")]
        #[state]
        pub(crate) genesis_hash: sov_state::StateValue<Vec<u8>>, // TODO: fix genesis serialiation incompatibility

        // #[cfg(feature = "aptos-consensus")]
        #[state]
        pub(crate) waypoint: sov_state::StateValue<String>, // TODO: fix waypoint serialiation incompatibility
    ...
    impl<C: sov_modules_api::Context> AptosVm<C> {
        pub(crate) fn get_validator_signer(
            ...
            Ok(
                serde_json::from_slice::<ValidatorSigner>(&serialized_validator_signer)
